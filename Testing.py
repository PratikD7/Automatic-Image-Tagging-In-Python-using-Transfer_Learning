...
classes = ['Board', 'Dust Pan', 'Fire_Extnguisher', 'Rubber Glove', 'Apple',
           'BackPack', 'Bowl', 'Cap', 'Cell Phone', 'Chair', 'Fan',
           'Flashlight', 'Football', 'Glasses', 'Guitar', 'Laptop',
           'Lightbulb', 'Mug', 'Pen', 'Plier', 'Shoe', 'Stapler',
           'Wall Clock', 'Water Bottle']
